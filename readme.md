...
| `/管理当前帖子权限组` | 帖子作者 | 在当前帖子管理至多5个人的权限组，权限组成员有权使用 `/更新推流 ` | 已开启更新的帖子 |
| `/更新推流` | 帖子作者/当前帖子权限组成员 | 向所有订阅该帖子或关注该作者的用户推送一条更新通知。 | 已开启更新的帖子 |
| `/查看订阅入口` | 所有用户 | 实时查看当前帖子的订阅入口，并且显示最新的更新信息 | 已开启更新的帖子 |
